...
public class WorkerCRUDOpsUsingJsonPath {

    @Test
    public void operationCRUDUsingJsonPath(){
        //create record using POST
        String response = postMethod("v1nz", "Automation Eng."); //passed wrong parameters
    ...
    @Test
    public String postMethod(String designation, String name) {
        RestAssured.baseURI = "http://localhost:3000";
        String body = WorkerDynamicJsonBodyViaParameters.getJsonBodyDynamic(designation, name);
